...
| :--- | :---: | :---: |
| **Slicer Compatibility** | ❌ Locked to Creality Print | ✅ OrcaSlicer & Creality Print |
| **Profile Categorization** | ❌ Forces "Generic" | ✅ Organized by Brand/Type/Name |
| **Custom RFID Tags** | ❌ Not supported | ✅ Supported (CFS & Side Spool) |
| **Filament Tracking** | ❌ Not supported | ✅ Tracks usage & remaining amount |
| **Multi-Printer Sync** | ❌ Manual | ✅ Simultaneous multi-IP sync |
...
Check out my other project [K2-mDNS](https://github.com/HurricanePrint/K2-mDNS) if you would like an easier way to connect to your printers. Instead of remembering IP's you can connect with a simple name like k2plus.local
...
* If you pick an already used id from a default profile, the profile will be overwritten with your custom profile. This is intended as you may want to update settings on stock profiles.
* 30000–99999 is a safe unused range of id's
* You can also use letters or a prefix in your id, such as `FS001` or `PLA01`

**Example configuration:**
```json
{"id":"FS345","vendor":"ELEGOO","type":"PLA","name":"Fast PLA"}
```
...
Sometimes you may not immediately see the updated profiles in the filament picker. It may take a few seconds for the printer to refresh with the newly synced database. You can force this refresh this by closing the printer and reopening the printer from the device tab in creality print. Or by rebooting the printer.
